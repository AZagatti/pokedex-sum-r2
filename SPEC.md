...
## Repo / deploy
Git remote (SSH): `https://github.com/AZagatti/pokedex-sum-r2.git` (already created, empty). `git init`, set remote `origin`, commit
in logical chunks, push to `main`. `paths.base` must be `/pokedex-sum-r2`. The live URL will be
`https://azagatti.github.io/pokedex-sum-r2/`.
