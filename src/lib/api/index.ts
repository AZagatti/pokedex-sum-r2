...
export async function getBerryDetail(
  nameOrId: string | number
): Promise<BerryDetail> {
...
export async function fetchBerryList(
  limit = 50,
  offset = 0
): Promise<BerryResponse | null> {
  try {
...
export async function fetchBerryDetail(
  nameOrId: string | number
): Promise<BerryDetail | null> {
  try {
